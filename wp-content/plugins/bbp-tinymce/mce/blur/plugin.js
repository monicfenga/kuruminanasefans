(function() {
	...
	/*jsc
["tinymce.plugins.blur.Plugin","tinymce.core.PluginManager","global!tinymce.util.Tools.resolve"]
jsc*/
 ...
 */
	...
	/**
 * This class contains all core logic for the blur plugin.
 *
 * @class tinymce.blur.Plugin
 * @private
 */
	define('tinymce.plugins.blur.Plugin', ['tinymce.core.PluginManager'],
	function(PluginManager) {
		PluginManager.add('blur',
		function(editor) {
			// Add a button that opens a window
			editor.addButton('blur', {
				icon: false,
				text: '■',
				tooltip: '刮开可见',
				onclick: function() {
					editor.insertContent('<p>[blur]替换我[/blur]</p>');
				}
	...
	dem('tinymce.plugins.blur.Plugin')();
})();